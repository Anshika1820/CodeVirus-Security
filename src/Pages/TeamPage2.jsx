      ...
      <section className="px-6 md:px-20 pb-20 -mt-16">
        ...
        >
          ...
          <div className="mt-12 space-y-6 text-sm md:text-base text-gray-700 leading-relaxed text-center max-w-4xl mx-auto">
            ...
            <p>
              V. Singh is a senior technology advisor with over 25 years of
              experience in enterprise IT systems, security strategy, and
              product engineering.
            </p>

            <p>
              He specializes in enterprise IT architecture design, developing
              robust security strategies, leveraging AI-enabled systems to
              drive innovation, and leading advanced enterprise consulting
              engagements.
            </p>
