    ...
    <div className="min-h-screen bg-white font-sans">
      ...
      <section className="px-6 md:px-20 py-20 bg-[#0B2A5B] text-white ">
        <div className="max-w-5xl mx-auto text-center ">
          ...
          <div className="inline-block px-6 py-2 bg-white/10 backdrop-blur-md border border-white/20 rounded-full shadow-xl shadow-[#0B2A5B]">
          ...
          <p className="mt-5 text-sm md:text-lg text-gray-200 max-w-2xl mx-auto leading-relaxed">
            Cybersecurity professionals delivering trusted, compliant, and enterprise-grade solutions for modern organizations.
          </p>
