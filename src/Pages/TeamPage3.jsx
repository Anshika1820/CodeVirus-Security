      ...
      <section className="px-6 md:px-20 pb-20 -mt-16">
        ...
        >
          ...
          <div className="mt-12 space-y-6 text-sm md:text-base text-gray-700 leading-relaxed text-center max-w-4xl mx-auto">
            ...
            <p>
              Dilip Singh is a Senior Security Analyst with over 12 years of
              experience in cybersecurity operations, network security,
              vulnerability management, and enterprise IT security.
            </p>
