      ...
      <section className="px-6 md:px-20 pb-20 -mt-12">
        ...
        >
          ...
          <div className="mt-12 space-y-6 text-sm md:text-base text-gray-700 leading-relaxed text-center max-w-4xl mx-auto">
            <p>
              Shreyansh Singh brings 3+ years of extensive experience in cybersecurity operations, 
              specializes in practical cybersecurity training and foundational security practices.
            </p>
            <p>
              He focuses on ethical hacking, network security, cyber awareness, and hands-on lab demonstrations.
            </p>
          </div>
